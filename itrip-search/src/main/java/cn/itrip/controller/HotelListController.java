...
public class HotelListController {
    ...
    public Dto<Page<itripHotelVo>> searchItripHotelPage(@RequestBody SearchHotelVO vo) {
        ...
        try {
            page = searchHotelService.searchltripHotelPage(vo, vo.getPageNo(), vo.getPageSize());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Dto<Page<itripHotelVo>> searchItripHotelListByHotCity(@RequestBody SearchHotCityVO vo) throws Exception {
        ...
        List list = searchHotelService.searchltripHotelistByHootCity(vo.getCityId(), vo.getCount());
